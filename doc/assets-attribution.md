The following is a list of assets used in the tipaulcoin source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://tipaulcointalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original tipaulcoin logo from Bitboy)
* License: MIT
